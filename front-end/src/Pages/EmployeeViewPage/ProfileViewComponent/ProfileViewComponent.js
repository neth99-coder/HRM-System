...
import {Breadcrumb, BreadcrumbItem, Card, CardBody, ListGroup, ListGroupItem, Button, Form} from "reactstrap";
                    ...
                    <div id="myModal" className={styles["modal"]} hidden={delVisibility}>
                        <div className={styles["modal-content"]}>
                            ...
                            <div className={styles["modal-body"]}>
                                <p>Are you sure you want to delete employee {props.employee.emp_id} ?</p>
                                        ...
                                        <div className="d-flex flex-column align-items-center text-center">
                                            ...
                                            <div className="row">
                                                    <div className="col-6">
                                                        ...
                                                        <Link to={"/hrmanager/employee/edit/"+ props.employee.emp_id}>
                                                    ...
                                                    <div className="col-6">
                                                        ...
                                                        <Button type="submit" id="submit" name="submit"  className="fa fa-trash">Delete</Button>
                                                        </Form>
                                                        {/*</Link>*/}
                                                    </div>
