  ...
  useEffect(()=>{
    const loadProfileData = async () => {
      await Axios.get(
       ...
       setDp((res.data.result[0]['profile_picture'] !== null && res.data.result[0]['profile_picture'] !== undefined && res.data.result[0]['profile_picture'] !== '')?res.data.result[0]['profile_picture']:"default.jpg");
